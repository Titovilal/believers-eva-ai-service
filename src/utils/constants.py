...
PARSE_PDF_DEFAULT_FORCE_OCR = False  # By default, prefer native text extraction (faster)
...
PARSE_PDF_DOCLING_IMAGE_AVG_OUTPUT_TOKENS = 1024  # Average output tokens per image (half of max 2048)

# Token estimation
PARSE_PDF_DOCLING_IMAGE_TOKENS_LOW_DETAIL = 70  # Tokens per image (low detail mode)
PARSE_PDF_DOCLING_IMAGE_TOKENS_HIGH_DETAIL = 630  # Estimated average for high detail (4 tiles typical)
